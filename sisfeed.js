...
(function () {
  ...
  function loadRandomPost(cb) {
    // Générer un ID aléatoire et récupérer le post le plus proche
    // pour avoir un vrai aléatoire sur toute la base
    ...
    db.collection('posts')
      ...
      .then(function (snap) {
        ...
        // Si rien trouvé vers le haut, chercher vers le bas
        db.collection('posts')
          .where('isExpired', '==', false)
          .where(firebase.firestore.FieldPath.documentId(), '<', randomId)
