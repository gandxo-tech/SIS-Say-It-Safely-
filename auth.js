// ================================================================
// SIS LIVE AUDIO - AUTHENTICATION V2 COMPLET
...
// ================================================================
// UPLOAD PHOTO PROFIL (LocalStorage)
// ================================================================
...
document.getElementById('photoInput')?.addEventListener('change', (e) => {
    ...
    if (!file.type.startsWith('image/')) {
        showToast('❌ Fichier non valide (image uniquement)');
        return;
    }
    ...
    reader.onload = (event) => {
        ...
        if (preview) {
            preview.innerHTML = `<img src="${tempPhotoData}" alt="Photo" style="width:100%;height:100%;object-fit:cover;border-radius:50%;">`;
        }
...
registerForm?.addEventListener('submit', async (e) => {
    ...
    try {
        ...
        // Sauvegarder photo dans localStorage
        if (tempPhotoData) {
...
console.log('✅ Auth module loaded (avec upload photo)');
